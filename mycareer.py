...
import os
import tempfile
# Imports que funcionam sem pacotes extras
...
st.title("Mu Career - AI Job Advisor")
...
if uploaded_file:
    with st.spinner("Processing your resume..."):
        ...
        try:
            ...
            task = st.radio("Choose a service:", ["Analyze Resume", "Find Matching Jobs"])
            ...
            if st.button("Run Analysis"):
                ...
                if task == "Analyze Resume":
                    ...
                    # Chama a sua ferramenta do Tools.py
